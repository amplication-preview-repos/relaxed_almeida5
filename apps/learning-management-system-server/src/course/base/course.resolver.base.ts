...
export class CourseResolverBase {
  ...
  async getTariff(@graphql.Parent() parent: Course): Promise<Tariff | null> {
    const result = await this.service.getTariff(parent.id);
